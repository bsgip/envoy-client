...
class DeviceInformation(BaseModel):
    ...
    mf_hw_ver: Optional[str] = Field(alias='mfHwVer', default='Unknown', description="Manufacturer hardware version")
    mf_id: Optional[int] = Field(alias='mfID', default=0, description='The manufacturer’s IANA Enterprise Number')
    ...
    mf_model: Optional[str] = Field(alias='mfModel', default='Unknown', description='Manufacturer’s model number')
    mf_ser_num: Optional[str] = Field(alias='mfSerNum', default='Unknown', description='Manufacturer assigned serial number')
